...
for (n_genes in c(256, 192, 128, 64, 32, 16, 8)) {
    fname <-
        paste0("/Users/fruity/Local/datasets/RGS/v1alm_gene_list_",
               n_genes,
               ".feather")
    startt <- Sys.time()
...
write_feather(time_df, "/Users/fruity/Local/datasets/RGS/v1alm_elapsed_time.feather")